...
describe('productsController', () => {
    ...
    it('create', async () => {
        await createUser();
        const response = await request.post('/api/products').send(newProduct).set('Authorization', 'Bearer ' + token);
    ...
    it('show', async () => {
        ...
        //get product
        const productResponse = await request.get(`/api/products/${response.body.id}`).set('Authorization', 'Bearer ' + token);
    ...
    it('index', async () => {
        ...
        //get product
        const productsResponse = await request.get("/api/products").set('Authorization', 'Bearer ' + token);
